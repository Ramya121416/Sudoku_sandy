...
function FillBoard(board) {
	for (var i = 0; i < 9; i++) {
		for (var j = 0; j < 9; j++) {
            if(j==2||j==5){
                document.getElementById(i*9+j).style.borderRight="3px solid black"
            }
            if(i==2||i==5){
                document.getElementById(i*9+j).style.borderBottom="3px solid black"
            }
			if (board[i][j] != 0) {
                document.getElementById(i * 9 + j).style.backgroundColor="#bdbcb9";
